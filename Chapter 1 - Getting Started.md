...
Git comes with a tool called <span style="color:red">git config</span style> that lets you get and set configuration variables that control all aspects of how Git looks and operates.
