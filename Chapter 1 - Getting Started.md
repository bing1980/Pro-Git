...
Git comes with a tool called <font color='red'>git config</font> that lets you get and set configuration variables that control all aspects of how Git looks and operates.
